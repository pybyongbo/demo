    ...
    J_Popup: function(o, $config, z) {
        ...
        var fn = {
            ...
            mask_load: function() {
                ...
                $("<div class='" + this.maskCls + " J_KCWidget' data-widget-type='Compatible' data-widget-config=\"{fixed:true}\" style=\"position:absolute;left:0;top:0;width:100%;height:"+ $("html").height() + 'px'+";z-index:9999;background:#000;\"></div>")
    ...
    J_Accordion: function(o, $config) {
        ...
        s.ex = {
            check: function(n) {
                ...
                //if (p hasClass('ks-active')) {return false};
                //console.log(s);
